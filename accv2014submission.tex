...
\begin{figure}[t!]
\begin{center}
   \includegraphics[width=0.9\linewidth]{figures/sun_moon.eps}
\end{center}
   \vspace{-0.6cm}
...
\begin{figure}[t!]
\begin{center}
   \includegraphics{figures/Background.eps}
\end{center}
   \vspace{-0.6cm}
...
\begin{figure}[t!]
\begin{center}
   \includegraphics[width=0.99\linewidth]{figures/sun_blocks2.pdf}
\end{center}
   \vspace{-0.6cm}
